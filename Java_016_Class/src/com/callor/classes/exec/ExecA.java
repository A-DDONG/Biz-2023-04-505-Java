...
public class ExecA {
	...
	public static void main(String[] args) {
		...
		// ScoreServiceA1 클래스에 정의된 method 를 사용하기 위하여
		// 클래스를 객체로 생성하는 절차
		...
		// makeScore() method 에게 전달하면서 뭔가(make) 요청하기
		scService.makeScore(scoreList);
		
		// makeScore() method 호출하기
		// method 를 호출하면서 scoreList 라는 데이터가 담긴
		// 객체변수dml "기억장치 주소"를 전달하고 
		// return된 결과를 result 변수에 저장해달라는 요청
