 ...
 * 가장 표준적인 코딩 스타일
 * 
 * Java 는 모든 코드(파일)가 기본적으로 class 로 부터 시작한다
 * 
 ...
 * main() method 를 포함하는 java 클래스 코드를 진입점 코드라고 한다
 * 
 */
public class ExecA {
	...
	public static void main(String[] args) {
		...
		// 배열에 값을 저장하기 위해서는 배열의 index 를 지정
		// 배열[index]
		...
		// nums 배열의 5번 index 에 저장된 값을 읽어서 Console 에 출력하라
