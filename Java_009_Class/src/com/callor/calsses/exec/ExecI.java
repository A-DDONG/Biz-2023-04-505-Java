...
public class ExecI {
	...
	public static void main(String[] args) {
		...
		if(lastIndex > -1) {
			...
			System.out.println("마지막에 3의 배수 값 : " + lastNum);
			System.out.println("마지막에 3의 배수 값 : " + nums[lastIndex]);
		} else {
		 ...
		 * index 종료값 : index > 0 조건이 있어서 index 1 일 경우 for() 종료
		 * 49,48,47,46 ... 0 까지 index 값을 생성해야 하는데
		 * 여기의 코드는 50,49,48, ... 1까지 index가 생성되고 있다
