...
public class StringA {
	...
	public static void main(String[] args) {
		...
		/*
		 * String.format() 문자열을 format 형식 문자열로 변환하는 method System.out.printf() 와 유사한데
		 * ..printf() 는 결과를 단순히 Console 에 출력하는 용도 String.format() 은 결과를 다른 문자열 변수에 저장할 수
		 * 있다
		 * 
		 * printf() 는 아마도 void printf() 일 것이고 format() 은 아마도 String format() 이고 return
		 * 문이 있을 것이다
		 */
		int num = 3;
		...
		// printf() 사용해 문자열 format 을 지정하고 싶은데
		// printf() 단순히 console 에 출력하는 일만 할수있다
		// printf() method 는 void return type 이기 때문이다
		// printf() method 를 대신하여 결과를 변수에 저장하고 싶을때는
