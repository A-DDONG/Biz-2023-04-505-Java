...
public class StudentServiceImplV1 implements StudentService {
	...
	/*
	 * insertStudent method는 Student Service interface에 정의되지 않은 method 이 method는
	 * 상속받은 것이 아니고 V1 클래스에서 임의로 생성한 method이다
	 */
	public void insertStudent() {
		while (true) {
			...
			while (true) {
				...
				try {
					...
					System.out.println("학년은 1 ~ 4 의 값만 입력해주세요");
					continue;
				}
				if (intGrade > 4 || intGrade < 1) {
					System.out.println("학년은 1 ~ 4의 값만 입력해주세요");
					continue;
				}
				break;
			}
		...
		// 현재 입력한 학생정보의 stdList가 모두 만들어진 상태
	}
