...
public class VarCB {
	...
	public static void main(String[] args) {
		 ...
		 * floatNum1 에 결과가 저장이 되더라도 원래결과와 저장된 변수의
		 * type이 달라서 코드가 실행되는 과정에서 문제가 발생할 수 있다
		 * 때문에 결과에 정확히 일치한 type의 변수에
		 * 결과를 보관하는 것이 좋다
		 */
		 ...
		 * 값은 중요하지 않다
		 * 때문에 반드시 결과를 저장할 변수의 type 은 정수형이어야 한다
		 */
		int intYes1 = intNum1 % 2;
		
		/*
		 * intNum1 % 2 == 0 연산의 최종결과는 boolean type 이다
		 * 값은 중요하지 않다
		 * 결과값을 저장하려면 반드시 boolean type 의 변수에 저장해야 한다
		 */
